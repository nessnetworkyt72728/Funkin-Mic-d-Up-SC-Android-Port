...
class Paths
{
	...
	{
		return 'songs:assets/songs/${song.toLowerCase()}/Voices_HIFI.$SOUND_EXT';
	}
	
	inline static public function voicesLOFI(song:String)
	{
		return 'songs:assets/songs/${song.toLowerCase()}/Voices_LOFI.$SOUND_EXT';
	}
	...
	{
		return 'songs:assets/songs/${song.toLowerCase()}/Inst_HIFI.$SOUND_EXT';
	}

	inline static public function instLOFI(song:String)
	{
		return 'songs:assets/songs/${song.toLowerCase()}/Inst_LOFI.$SOUND_EXT';
	}
